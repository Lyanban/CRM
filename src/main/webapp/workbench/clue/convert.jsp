      ...
      $(function () {
          ...
          $("#convertBtn").on("click", function () {
              ...
              if ($("#isCreateTransaction").prop("checked")) {
                  ...
                  location.href = "workbench/clue/convert.do?clueId=${param.id}";
              }
          });
      });
          ...
          $.getJSON(
              ...
              function (resp) {
                  ...
                  $.each(resp, function (index, item) {
                      html += "<tr>" +
                          "<td><input type='radio' name='xz' value='" + item.id + "'/></td>" +
...
<div id="create-transaction2"
  ...
  <form id="tranForm" action="workbench/clue/convert.do" method="post">
    ...
    <div class="form-group" style="width: 400px;position: relative; left: 20px;">
      ...
      <input type="text" class="form-control time" id="expectedClosingDate" name="expectedDate" placeholder="请选择日期" readonly>
    </div>
    <div class="form-group" style="width: 400px;position: relative; left: 20px;">
