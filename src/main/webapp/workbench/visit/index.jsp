    ...
    <div class="btn-toolbar" role="toolbar"
      ...
      <div class="btn-group" style="position: relative; top: 18%;">
        <button type="button" class="btn btn-primary"
                onclick="window.location.href='workbench/visit/saveTask.jsp';">
          <span class="glyphicon glyphicon-plus"></span> 任务
        </button>
        <button type="button" class="btn btn-default" onclick="alert('可以自行实现对通话的管理');">
          <span class="glyphicon glyphicon-plus"></span> 通话
        </button>
        <button type="button" class="btn btn-default"
                onclick="window.location.href='workbench/visit/editTask.html';">
        ...
        <tr>
          ...
          <td>
            <a style="text-decoration: none; cursor: pointer;"
               onclick="window.location.href='workbench/visit/detail.jsp';">拜访客户</a>
          </td>
          <td>2017-07-09</td>
          <td>李四先生</td>
          <td>未启动</td>
